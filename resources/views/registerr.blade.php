    ...
    <div class="row justify-content-center align-items-center inner-row">
        ...
        <div id="error" style="margin-left: 8px;">     </div>
                <form action="{{ route('registered') }}" method="post">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control form-control-sm" placeholder="Email" id="lastName" name="email">
                    ...
                    @enderror
                    <div class="form-floating mb-3">
                        <input type="password" class="form-control form-control-sm" placeholder="Password" id="email" name="password">
                    ...
                    @enderror
                    <div class="mt-3">
                        <button class="btn primarybg text-white" name="name"> Submit</button>
                    </div>
                </form>
                <div class="mt-3">
                    <span>Don't have an account?</span><button class="p-0 border-0 bg-transparent primaryColor"><a href="{{ route('login') }}"> Login</a></button>
                </div>
            </div>
        </div>
    </div>
